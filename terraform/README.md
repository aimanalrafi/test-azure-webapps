...
```
curl "https://nubesgen.com/demo.zip?iactool=TERRAFORM&region=westeurope&application=APP_SERVICE.basic&runtime=DOCKER&database=POSTGRESQL.general_purpose&addons=redis,storage_blob&network=VIRTUAL_NETWORK" | tar -xzvf -
```
